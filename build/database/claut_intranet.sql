-- Base de datos para el sistema Claut Intranet
...
CREATE TABLE IF NOT EXISTS comites (
    ...
    fecha_actualizacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (presidente_id) REFERENCES usuarios_perfil(id) ON DELETE SET NULL
);

-- Tabla de miembros de comités
...
CREATE TABLE IF NOT EXISTS eventos (
    ...
    fecha_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (organizador_id) REFERENCES usuarios_perfil(id) ON DELETE SET NULL,
    FOREIGN KEY (comite_id) REFERENCES comites(id) ON DELETE SET NULL
);

-- Tabla de boletines/anuncios
CREATE TABLE IF NOT EXISTS boletines (
    ...
    fecha_creacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (autor_id) REFERENCES usuarios_perfil(id) ON DELETE SET NULL
);
...
-- Tabla de contactos (para atención directa)
CREATE TABLE IF NOT EXISTS contactos (
    ...
    FOREIGN KEY (respondido_por) REFERENCES usuarios_perfil(id) ON DELETE SET NULL
);
...
INSERT INTO usuarios_perfil (nombre, apellido, email, password, telefono, empresa_id, rol, estado) VALUES
